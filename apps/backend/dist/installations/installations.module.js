...
exports.InstallationsModule = InstallationsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: installation_schema_1.Installation.name, schema: installation_schema_1.InstallationSchema }]),
        ],
...
//# sourceMappingURL=installations.module.js.map