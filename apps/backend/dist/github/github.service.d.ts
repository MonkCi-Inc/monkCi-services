export declare class GitHubService {
    ...
    getRepositoryRunners(installationId: number, owner: string, repo: string): Promise<{
        id: number;
    ...
    getRepositoryRunner(installationId: number, owner: string, repo: string, runnerId: number): Promise<{
        id: number;
        runner_group_id?: number;
        name: string;
        os: string;
    ...
    getRepositoryWorkflows(installationId: number, owner: string, repo: string): Promise<{
        id: number;
        node_id: string;
        name: string;
        path: string;
    ...
    getWorkflowRuns(installationId: number, owner: string, repo: string, workflowId: number): Promise<{
        id: number;
        name?: string | null;
        node_id: string;
    ...
    getWorkflowRunLogs(installationId: number, owner: string, repo: string, runId: number): Promise<unknown>;
}
